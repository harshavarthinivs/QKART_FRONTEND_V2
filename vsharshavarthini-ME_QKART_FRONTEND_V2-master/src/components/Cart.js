...
export const generateCartItemsFrom = (cartData, productsData) => {
  // console.log("generatecartdata",cartData);
  // console.log("generateproductsdata",productsData);
  const items = [];
       ...
       <Box
        ...
        <Box
          ...
          <Box color="#3C3C3C" alignSelf="center" fontWeight="700"
            fontSize="1.5rem" pb="0.5rem">
            Total
          </Box>
          <Box color="#3C3C3C" alignSelf="center" fontWeight="700"
            fontSize="1.5rem" >${getTotalCartValue(items)}</Box>
        </Box>
