 ...
 *
 */
const AddNewAddressView = ({ token, newAddress, se, addAddress }) => {
  return (
    <Box display="flex" flexDirection="column">
      <TextField
        ...
        onChange={(e) => {
          se({ ...newAddress, value: e.target.value });
        }}
      />
...
const Checkout = () => {
  ...
  const deleteAddress = async (token, addressId) => {
    try {
      ...
      setAddresses({ all: deletedata.data });
      ...
      <Grid container>
        <Grid item xs={12} md={9}>
          <Box className="shipping-container" minHeight="100vh">
            ...
            {/* TODO: CRIO_TASK_MODULE_CHECKOUT - Dislay either "Add new address" button or the <AddNewAssViewddre> component to edit the currently selected address */}
